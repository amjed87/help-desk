    ...
    return (
        <section className='text-center' >
            <div className="container mx-auto lg:max-w-screen-xl md:max-w-screen-md px-4">
                <h2 className="text-midnight_text text-2xl font-semibold">تستخدم مديرية الاتصالات والنظم المعوماتية افضل التقنيات الحديثة في انشاء الانظمة والبرمجيات لتقديم اافضل الخدمات </h2>
